#import "../data/songs/duality.typ":*
#import "../data/songs/gangstas-paradise.typ":* 
#import "../data/songs/pneuma.typ":* 
#import "../data/songs/virtual-insanity.typ":* 

/*
Author: { Override } -> <a href={https://github.com/TuringProblem/}>Github Profile</a>
since: 20260520 : @07:25
*/
...
#let mainContent(songTitle: "", songUrl: "", songStyle: "", artist: "", content: "") = {
  ...
  let songLogic = if songUrl == "" { } else { link(songUrl)[#emph(text(blue)[#songTitle])] + " - " + artist + " " + text(size: 8pt)[(#songStyle)]}
